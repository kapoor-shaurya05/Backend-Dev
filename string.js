...
console.log(str.replace("shaurya","SHAURYA"));  //replace substring  //replaces the substring "shaurya" with "SHAURYA" in the string 'str' and prints the result to the console
